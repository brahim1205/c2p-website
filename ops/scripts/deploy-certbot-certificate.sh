...
install -d -o root -g 101 -m 0750 "${CERT_DIR}"
install -o root -g 101 -m 0644 "${LINEAGE}/fullchain.pem" "${CERT_DIR}/fullchain.pem.new"
install -o root -g 101 -m 0640 "${LINEAGE}/privkey.pem" "${CERT_DIR}/privkey.pem.new"
