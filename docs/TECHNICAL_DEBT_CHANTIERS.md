...
- fondation Project Center ajoutee pour `projects`, `project_milestones`, `project_documents` et `project_history` avec projection double-run Prisma et check de coherence dedie.
...
- 35 tables avec projection normalisee ou auth normalisee;
