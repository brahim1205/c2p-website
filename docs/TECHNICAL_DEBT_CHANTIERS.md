...
- fondation Project Center ajoutee pour `projects`, `project_milestones` et `project_documents` avec projection double-run Prisma et check de coherence dedie.
...
- 34 tables avec projection normalisee ou auth normalisee;
