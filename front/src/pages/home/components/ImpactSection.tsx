...
export default function ImpactSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-32 px-4 sm:px-6 lg:px-20 bg-gradient-to-b from-[#0f3d3e] to-[#0a2a2b] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[#14B8A6]/8 rounded-full blur-[150px] pointer-events-none animate-pulse-glow"></div>
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#14B8A6]/5 rounded-full blur-[120px] pointer-events-none animate-pulse-glow" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`mb-12 lg:mb-20 transition-all duration-1000 ease-out ${sectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-block bg-[#14B8A6]/20 px-6 py-2.5 rounded-full mb-6">
            <span className="text-[#14B8A6] text-sm font-medium">/ Impact</span>
          </div>
        ...
        <div className={`flex flex-col lg:flex-row gap-12 lg:gap-16 items-center mb-20 transition-all duration-1000 delay-300 ease-out ${sectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="w-full lg:w-[40%] relative group">
            <div className="absolute -inset-4 bg-[#14B8A6]/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <img
              src="https://readdy.ai/api/search-image?query=modern%20professional%20development%20center%20interior%20with%20collaborative%20workspace%20showing%20training%20rooms%20and%20coworking%20areas%20with%20contemporary%20design%20and%20bright%20atmosphere&width=600&height=600&seq=c2p-space&orientation=squarish"
              alt="Espace C2P"
            ...
            />
            {/* Floating badge */}
            <div className="absolute -bottom-4 -right-4 bg-[#14B8A6] text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg animate-float z-20">
          ...
          <div className="flex-1">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/auth/register"
                className="inline-flex items-center gap-2 bg-white text-[#0a2a2b] px-8 py-4 rounded-full text-base font-semibold hover:bg-[#14B8A6] hover:text-white hover:scale-105 active:scale-95 transition-all duration-300 whitespace-nowrap shadow-lg"
              >
