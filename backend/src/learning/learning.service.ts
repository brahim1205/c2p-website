...
export class LearningService {
  ...
  async createFormateurQuizQuestion(examId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.createFormateurQuizQuestion(examId, payload, user);
  }
  async updateFormateurQuizQuestion(questionId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.updateFormateurQuizQuestion(questionId, payload, user);
  }
  async deleteFormateurQuizQuestion(questionId: string, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.deleteFormateurQuizQuestion(questionId, user);
  }
  async reorderFormateurQuizQuestion(examId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.reorderFormateurQuizQuestion(examId, payload, user);
  }
  async createFormateurQuizChoice(examId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.createFormateurQuizChoice(examId, payload, user);
  }
  async updateFormateurQuizChoice(choiceId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.updateFormateurQuizChoice(choiceId, payload, user);
  }
  async deleteFormateurQuizChoice(examId: string, choiceId: string, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.deleteFormateurQuizChoice(examId, choiceId, user);
  }
  async reorderFormateurQuizChoice(examId: string, payload: unknown, user: AuthUser | null) {
    return this.learningAssessmentsCommandService.reorderFormateurQuizChoice(examId, payload, user);
  }
