...
import type {
  ...
  StoredUser,
  UserSession,
} from './auth.store-types.js';

export type * from './auth.store-types.js';
...
const users: StoredUser[] = [
  ...
  },
  {
    ...
    avatar: avatar('trainer-nonpremium-fatou'),
  ...
  },
  {
    ...
    avatar: avatar('provider-nonpremium-oumar'),
  ...
  },
  {
    ...
    avatar: avatar('founder-nonpremium-mamadou'),
